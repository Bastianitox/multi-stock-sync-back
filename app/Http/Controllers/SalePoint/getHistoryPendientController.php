    ...
    public function getHistoryPendient(Request $request,$clientId)
    {
        try {
            ...
            $sales = Sale::with([
                ...
                'client:id,nombres,apellidos,rut,razon_social'
            ])
            ...
            $formattedSales = $sales->map(function ($sale) {
                return [
                    ...
                    'client_name' => $sale->client ? trim($sale->client->nombres . ' ' . $sale->client->apellidos) : 'N/A',
                    'client_rut' => $sale->client->rut ?? 'N/A',
                    'client_business_name' => $sale->client->razon_social ?? 'N/A',
